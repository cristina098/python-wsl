...
f = open(f'/home/cristina/python-wsl/python-wsl/METEO/ECMWF-EU-{firstDate}.json',)
data = json.load(f)
f.close()
...
for i in range(filesNo):
    ...
    f = open(f'/home/cristina/python-wsl/python-wsl/METEO/ECMWF-EU-{fileTime}.json',)
...
#allData.to_csv('/home/cristina/python-wsl/python-wsl/METEO/ECMWF-EU.csv')
#allDataDiff.to_csv('/home/cristina/python-wsl/python-wsl/METEO/ECMWF-EU-diff.csv')
