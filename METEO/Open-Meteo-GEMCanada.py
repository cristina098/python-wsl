...
url = "https://api.open-meteo.com/v1/gem?latitude=47.151726&longitude=27.587914&hourly=temperature_2m&timezone=Africa%2FCairo"
req = requests.get(url, headers=headers)
...
filename = f"GEM-Canada-{myDict['RO']['now']}.json"
