...
f = open(f'/home/lali/python/METEO/MET-Norway-{firstDate}.json',)
data = json.load(f)
f.close()
...
for i in range(filesNo):
    ...
    f = open(f'/home/lali/python/METEO/MET-Norway-{fileTime}.json',)
    data = json.load(f)
    f.close()
...
allData.to_csv('/home/lali/python/METEO/MET-Norway.csv')
