...
f = open(f'/home/lali/TITAN-ROG-sync/python/METEO/Open-Meteo-{firstDate}.json',)
data = json.load(f)
f.close()
...
for i in range(filesNo):
    ...
    f = open(f'/home/lali/TITAN-ROG-sync/python/METEO/Open-Meteo-{fileTime}.json',)
