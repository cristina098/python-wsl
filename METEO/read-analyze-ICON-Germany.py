...
print(f"You have {filesNo} ICON-Germany files")

############################################################################ read first file to build df structure
f = open(f'/home/cristina/python-wsl/python-wsl/METEO/ICON-Germany-{firstDate}.json',)
data = json.load(f)
f.close()
...
for i in range(filesNo):
    ...
    f = open(f'/home/cristina/python-wsl/python-wsl/METEO/ICON-Germany-{fileTime}.json',)
...
#allData.to_csv('/home/cristina/python-wsl/python-wsl/METEO/ICON-Germany.csv')
#allDataDiff.to_csv('/home/cristina/python-wsl/python-wsl/METEO/ICON-Germany-diff.csv')
